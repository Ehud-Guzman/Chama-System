...
// Closing balances for week 60 — the "Previous" column of the week 61 ledger
const MEMBERS = [
  ['Evans Ndungu', 94100],
  ['Patrick Njuguna', 63000],
  ['Benard Ngugi', 81700],
  ['Ndungu Mbugua', 62350],
  ['Joseph Ndegwa', 81000],
  ['Victor Kamau', 90200],
  ...
  ['Benson Maina', 70000],
  ['Benson Kaniu', 78260],
  ['Eustace Mugwanja', 64450],
  ['Joseph Gitonga', 71100],
  ['Wilson Kabichu', 70500],
  ['James Gachara', 39900],
  ['Erick Mwangi', 60550],
  ['Erick Njogu', 36700],
  ['Dennis Wasike', 80600],
  ['Samuel Gachara', 55200],
  ['Zabron Macharia', 67600],
  ['Paul Kimani', 58700],
  ['Dickson Karethi', 66050],
  ['Jackson Nakhulo', 45600],
  ['Isaiah Maina', 70450],
  ['Harrison Kamau', 74400],
  ['Stanly Gachara', 23750],
  ['George Ngechu', 64400],
  ['Joshua Maina', 72200],
  ['Isaac Njenga', 61500],
  ['John Maina', 67500],
