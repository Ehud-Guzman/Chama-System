...
// Parses member CSV content. Expected columns: name, phone, email (optional),
// regNumber (optional), notes (optional). Header names are matched
// case-insensitively; extra columns are ignored.
// Returns [{ rowNumber, name, phone, email, regNumber, notes }] — rowNumber is
// the line in the original file (header = row 1), so error reports point at the
// right line.
