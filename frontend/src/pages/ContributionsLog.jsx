...
import BulkContributionGrid from '../components/contributions/BulkContributionGrid';
...
export default function ContributionsLog() {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`min-h-11 rounded-lg border px-3 text-sm font-semibold ${
              mode === 'single' ? 'border-primary bg-primary/10 text-primary' : 'border-rule text-muted'
            }`}
          >
            Single entry
          </button>
          <button
            ...
            className={`min-h-11 rounded-lg border px-3 text-sm font-semibold ${
              mode === 'grid' ? 'border-primary bg-primary/10 text-primary' : 'border-rule text-muted'
            }`}
          >
            Weekly grid
          </button>
      ...
      {mode === 'grid' && (
        <BulkContributionGrid onLogged={() => load(1, methodFilter, typeFilter)} />
      )}
